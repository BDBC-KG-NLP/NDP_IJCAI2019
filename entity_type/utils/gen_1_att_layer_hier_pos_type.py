...
def gen_hier_type(model_args,pos_types):
  ...
  pos_type_mask_l1 = np.asarray([model_args.type_tree.typeToken_num]*model_args.args.max_pos_type_l1)
  pos_type_mask_l2 = np.asarray([[model_args.type_tree.typeToken_num]*args.max_pos_type_l2]*model_args.args.max_pos_type_l1)
  ...
  for key_l1 in l1_dict:
    ...
    pos_type_mask_l1[l1_id]=model_args.type_tree.typeToken2id[key_l1]
    ...
    for key_l2 in l2_dict:
      ...
      if key_l2.startswith(key_l1):
        if type_id_l2 in pos_types:
          ...
          pos_type_mask_l2[l1_id][l2_id]=model_args.type_tree.typeToken2id[key_l2]
          l2_id += 1
    ...
    if model_args.args.is_add_fnode==True or l2_id ==0:
      if type_id in pos_types:
        ...
        pos_type_mask_l2[l1_id][l2_id]=model_args.type_tree.typeToken2id[key_l1+'_s']  #add the stop tokens
        l2_id += 1
