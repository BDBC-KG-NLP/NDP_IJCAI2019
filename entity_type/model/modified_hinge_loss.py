...
loss_module = tf.load_op_library('/home/wjs/demo/entityType/new_EntType/lib/modified_hinge_loss.so')
loss_grad_module = tf.load_op_library('/home/wjs/demo/entityType/new_EntType/lib/modified_hinge_loss_grad.so')
...
def _max_margin_loss_grad(op, grad):
    ...
    gradIn1, gradIn2, gradIn3 = loss_grad_module.modified_hinge_loss_grad(scores,
                                                                          ...
                                                                          use_clean=use_clean)
    #tf.mul 
    gradOut = tf.multiply(grad, gradIn1)
